...
const MD_C = {
  ...
  inverseOnSurface: '#F4F6FE',
  secondaryContainer: '#DCE4FF',
  primaryFixedDim: '#A7B4E8',
  onSurface: '#101828',
  onSurfaceVar: '#475467',
  onPrimaryContainer: '#12183F',
  primary: '#2E5BFF',
  frameBorder: 'rgba(18,24,63,0.28)',
};
...
function AndroidDevice({
  ...
  return (
    ...
    <div data-om-starter="android-frame" style={{
      ...
      background: dark ? '#0C1024' : MD_C.surface,
